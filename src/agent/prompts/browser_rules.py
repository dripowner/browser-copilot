...
### browser_run_custom - последний вариант

browser_run_custom - это FALLBACK для крайних случаев когда стандартные browser_* tools не справляются.
Прежде чем использовать его - убедись что стандартные tools действительно не подходят.
